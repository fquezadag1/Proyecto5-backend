...
mercadopago.configure({
    access_token: "TEST-8337801143198563-120523-c838053b1e2fac4a269b16d38bf83097-1578915349"
})
...
app.post("/crear-producto", async (req, res) => {
    ...
    try {
        ...
        const nuevoProducto = await Producto.create({ nombre, precio, imagen, viscosidad })
        ...
        res.status(500).json({
            msg: "Hubo un error creando Producto",
            error
        })
...
app.delete("/borrar-producto", async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({
            msg: "Hubo un error borrando Prodcuto especificado"
        })
    }
